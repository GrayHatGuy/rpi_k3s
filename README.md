...
- Afer flash is complete mount SD card and/or USB to modify the follown with a text editor prior to boot. Save a backup copy of /boot/cmdline.txt before editing.  
